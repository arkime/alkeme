...
A terminal user interface (TUI) for the [Arkime](https://arkime.com) <a href="https://github.com/arkime/alkeme/raw/refs/heads/main/assets/alkeme.mp4" type="audio/mpeg">🔊</a> ecosystem, built with Rust and [ratatui](https://github.com/ratatui/ratatui).
