...
A terminal user interface (TUI) for the [Arkime](https://arkime.com) <audio controls src="https://github.com/arkime/alkeme/raw/refs/heads/main/assets/alkeme.mp3" type="audio/mpeg"></audio> ecosystem, built with Rust and [ratatui](https://github.com/ratatui/ratatui).
